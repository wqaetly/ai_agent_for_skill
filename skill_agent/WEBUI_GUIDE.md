...
skill_agent WebUI 是一个基于LangGraph 和agent-chat-ui 的可视化技能分析系统，让策划人员可以通过网页界面进行技能的分析、开发和修复工作。
...
3. **环境变量**
   - `DEEPSEEK_API_KEY`: DeepSeek API 密钥（用于LLM 调用）
