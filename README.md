...
[快速开始](#-快速开�? �?[主要功能](#-主要功能) �?[技术架构](#-技术架�? �?[Roadmap](#-roadmap)
...
**AI Agent for Skill** 是一个基�?**RAG（检索增强生成）** �?**LangGraph** 技术的智能技能配置系统，专为游戏策划人员设计。通过本地网页界面，策划可以使用自然语言描述需求，系统自动生成、验证和修复Unity技能配置JSON，大幅提升技能设计效率�?

### 🎯 核心价�?

- 🚀 **零代码生�?*：用自然语言描述，自动生成完整技能配�?
- 🔍 **智能分析**：语义搜索技能库，快速找到相似技能参�?
