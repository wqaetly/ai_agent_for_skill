...
namespace SkillSystem.Actions
{
    ...
    /// 适用于复杂的伤害计算公式，如"基础伤害 + 130%额外攻击�?+ 80%法强"�?
    /// 典型应用：泰达米尔E技能、瑞文R技能等需要多属性缩放的技能�?
    /// 伤害计算公式：基础伤害(随等�? + Σ(属性�?× 缩放系数)
    /// </summary>
    [Serializable]
    [ActionDisplayName("属性缩放伤�?)]
    public class AttributeScaledDamageAction : ISkillAction
    {
        ...
        [Range(0f, 0.5f)]
        [InfoBox("伤害浮动范围�?.1表示±10%的伤害浮�?)]
        /// <summary>伤害浮动系数，产生随机伤害变�?/summary>
        ...
        /// <summary>属性缩放数组，定义伤害如何基于角色属性缩�?/summary>
        ...
        [ShowIf("canCritical")]
        /// <summary>使用施法者的暴击率，false时使用下面的固定暴击�?/summary>
        ...
        /// <summary>固定暴击率，仅在不使用施法者暴击率时有�?/summary>
        ...
        [ShowIf("canCritical")]
        /// <summary>暴击特效，暴击时的额外视觉效�?/summary>
        ...
        /// <param name="attributeType">属性类�?/param>
        /// <returns>属性数�?/returns>
    ...
    public struct AttributeScaling
    {
        ...
        [InfoBox("缩放比例�?.3表示130%�?.8表示80%")]
        /// <summary>缩放比例，属性对伤害的影响系�?/summary>
        public float scalingRatio;
    }

    /// <summary>可用于伤害缩放的属性类�?/summary>
    public enum ScalingAttributeType
    {
        TotalAttackDamage,      // 总攻击力（基础+额外�?
        BonusAttackDamage,      // 额外攻击力（仅装�?符文提供的）
        SpellPower,             // 法术强度
        MaxHealth,              // 最大生命�?
        CurrentHealth,          // 当前生命�?
        MissingHealth,          // 已损失生命�?
