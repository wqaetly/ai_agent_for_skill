...
namespace SkillSystem.Actions
{
    ...
    public class SummonAction : ISkillAction
    {
        ...
        /// <summary>生存时间模式，决定召唤物的生命周期管理方�?/summary>
        ...
        /// <summary>继承召唤者属性，true时召唤物会继承部分召唤者的属�?/summary>
        ...
        /// <summary>召唤特效，召唤时播放的视觉效�?/summary>
        ...
        /// <summary>召唤音效，召唤时播放的音频效�?/summary>
        public AudioClip summonSound;

        /// <summary>已召唤的实例列表，追踪当前存在的召唤�?/summary>
        ...
        /// <param name="casterPosition">召唤者位�?/param>
        /// <param name="index">召唤物索�?/param>
        ...
        /// <param name="summon">要销毁的召唤�?/param>
